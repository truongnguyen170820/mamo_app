...
class HistoryTranscationState extends Equatable{
  ...
  HistoryTranscationState({this.err, this.transactionHistoryModel, this.status = AppConstants.STATUS_INITIAL});
  HistoryTranscationState updateWith({  final String err,
  final List<TransactionHistoryModel> transactionHistoryModel,
  final int status}){
